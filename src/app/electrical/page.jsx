...
import { ELECTRICAL_CATEGORIES } from "@/lib/electricalCategories";
import Footer from "@/components/layout/Footer";

const QUICK_LINKS = [
  { label: "Switches", slug: "switches-sockets" },
  { label: "Wires", slug: "wires-cables" },
  { label: "MCBs", slug: "mcbs-dbs" },
  { label: "Fans", slug: "fans" },
  { label: "LED Lights", slug: "lights-fixtures" },
  { label: "Conduits", slug: "conduits-accessories" },
];
      ...
      <section className="bg-primary px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-accent">
            BuildBudy Electrical
          </p>
          <h1 className="mt-3 text-3xl font-bold leading-tight text-white sm:text-4xl">
            Electrical Supplies & Fittings
          </h1>
          <p className="mt-3 text-base text-white/60">
            Switches, wires, MCBs, conduits, fans & lighting — everything for a safe electrical installation.
          </p>
          ...
          <form onSubmit={handleSearch} className="mx-auto mt-7 flex max-w-xl overflow-hidden rounded-lg shadow-lg">
            <input
              ...
              placeholder="Search switches, wires, MCBs, fans…"
      ...
      <main className="mx-auto w-full max-w-[1400px] flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 overflow-hidden rounded-xl bg-primary px-6 py-8 sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <h3 className="mt-1 text-xl font-bold text-white">
              ISI-Marked Wires & MCBs
            </h3>
            <p className="mt-1 text-sm text-white/60">
              Only BIS-certified electrical products. Free delivery on orders above ₹999.
            </p>
          </div>
          <Link
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              "Havells", "Legrand", "Finolex", "Crompton", "Anchor",
              "Schneider Electric", "Siemens", "Polycab", "GM Electrical",
              "Philips", "Osram", "Wipro Lighting",
            ].map((brand) => (
              <span
                key={brand}
