...
import { Search, ChevronRight, Armchair } from "lucide-react";
import { FURNITURE_CATEGORIES } from "@/lib/furnitureCategories";
...
const FEATURED = [
  {
    slug: "sofas",
    headline: "Living Room Makeover",
    sub: "Premium sofas, recliners & L-shapes for every space",
    cta: "Shop Sofas",
  },
  {
    slug: "office",
    headline: "Home Office Setup",
    sub: "Ergonomic chairs, desks & workstations for remote work",
    cta: "Shop Office Furniture",
  },
  {
    slug: "beds",
    headline: "Bedroom Essentials",
    sub: "Beds, mattresses & wardrobes for a restful space",
    cta: "Shop Bedroom",
  },
];

const BRANDS = [
  "Godrej Interio", "Nilkamal", "Durian", "Urban Ladder",
  "HomeTown", "Zuari", "Featherlite", "Spacewood",
  "Wakefit", "SleepyCat", "Pepperfry", "@Home",
];
    ...
    <div className="flex min-h-[calc(100vh-7rem)] flex-col bg-[#F5F6F8]">
      ...
      <section className="bg-primary px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-base text-white/60">
            Sofas, beds, chairs, tables & office furniture from India's most trusted brands.
          </p>
          ...
          <form onSubmit={handleSearch} className="mx-auto mt-7 flex max-w-xl overflow-hidden rounded-xl shadow-lg">
            <input
              ...
              placeholder="Search sofa, bed, wardrobe, dining table…"
      ...
      <main className="mx-auto w-full max-w-[1400px] flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 overflow-hidden rounded-2xl bg-primary px-6 py-8 sm:flex sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-accent">New Arrivals</p>
            <h3 className="mt-1 text-xl font-bold text-white">Ergonomic Office Chairs — 20% Off</h3>
            <p className="mt-1 text-sm text-white/60">Work from home in comfort. Free delivery on orders above ₹999.</p>
          </div>
          <Link
