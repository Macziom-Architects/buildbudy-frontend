...
import { Search, ChevronRight, Paintbrush } from "lucide-react";
import { PAINT_CATEGORIES } from "@/lib/paintCategories";
import Footer from "@/components/layout/Footer";

const QUICK_LINKS = [
  { label: "Interior Paint",  slug: "interior" },
  { label: "Exterior Paint",  slug: "exterior" },
  { label: "Spray Paints",    slug: "spray-paints" },
  { label: "Waterproofing",   slug: "waterproofing" },
  { label: "Wood Finishes",   slug: "wood-finishes" },
  { label: "Brushes",         slug: "tools-accessories" },
];

const FEATURED = [
  {
    slug: "interior",
    headline: "Interior Transformation",
    sub: "Premium emulsions with anti-fungal & washable formulas",
    cta: "Shop Interior Paint",
  },
  {
    slug: "exterior",
    headline: "Exterior Weather Shield",
    sub: "All-season protection for Indian climate conditions",
    cta: "Shop Exterior Paint",
  },
  {
    slug: "waterproofing",
    headline: "Stop Leaks Permanently",
    sub: "Roof & basement waterproofing trusted by contractors",
    cta: "Shop Waterproofing",
  },
];

const BRANDS = [
  "Asian Paints", "Berger", "Dulux", "Nippon",
  "Nerolac", "Indigo", "Shalimar", "Jotun",
  "DrFixit", "Pidilite", "Snowcem", "ICI",
];
      ...
      <section className="bg-primary px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-base text-white/60">
            Interior, exterior, wood finishes and waterproofing from India's most trusted paint brands.
          </p>
          ...
          <form onSubmit={handleSearch} className="mx-auto mt-7 flex max-w-xl overflow-hidden rounded-xl shadow-lg">
            <input
              ...
              placeholder="Search Asian Paints, primers, emulsions…"
      ...
      <main className="mx-auto w-full max-w-[1400px] flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 overflow-hidden rounded-2xl bg-primary px-6 py-8 sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <h3 className="mt-1 text-xl font-bold text-white">10% Off Asian Paints Royale</h3>
            <p className="mt-1 text-sm text-white/60">Premium interior emulsion. Use code PAINT10 at checkout.</p>
          </div>
          <Link
            href="/paint/interior"
