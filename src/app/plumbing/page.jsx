...
import { Search, ChevronRight, Droplets } from "lucide-react";
import { PLUMBING_CATEGORIES } from "@/lib/plumbingCategories";
import Footer from "@/components/layout/Footer";

const QUICK_LINKS = [
  { label: "CPVC Pipes",     slug: "cpvc-pipes" },
  { label: "Wash Basins",    slug: "wash-basins" },
  { label: "Valves",         slug: "valves" },
  { label: "Showers",        slug: "showers" },
  { label: "Toilets",        slug: "toilets" },
  { label: "Drainage",       slug: "drainage" },
];
...
const FEATURED = [
  {
    ...
    sub: "Premium faucets & wash basins from Jaquar, Cera & Parryware",
    cta: "Shop Basins",
  },
  {
    slug: "showers",
    headline: "Shower Systems",
    sub: "Overhead, hand-held & rain showers for every bathroom",
    cta: "Shop Showers",
  },
  {
    slug: "cpvc-pipes",
    headline: "CPVC Pipe Systems",
    sub: "ISI-marked CPVC & UPVC pipes for hot & cold water",
    cta: "Shop Pipes",
  },
];

const BRANDS = [
  "Astral", "Jaquar", "Cera", "Parryware", "Supreme",
  "Finolex", "Havells", "CPVC Pro", "Prince", "Vectus",
  "Hindware", "Kohler", "Grohe", "Roca",
];
      ...
      <section className="bg-primary px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-base text-white/60">
            Pipes, fittings, faucets, tanks and bathroom essentials from India's top brands.
          </p>
          ...
          <form onSubmit={handleSearch} className="mx-auto mt-7 flex max-w-xl overflow-hidden rounded-xl shadow-lg">
            <input
              ...
              placeholder="Search pipes, faucets, tanks, showers…"
      ...
      <main className="mx-auto w-full max-w-[1400px] flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 overflow-hidden rounded-2xl bg-primary px-6 py-8 sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <h3 className="mt-1 text-xl font-bold text-white">15% Off Jaquar Faucets</h3>
            <p className="mt-1 text-sm text-white/60">Premium bath fittings. ISI certified. Delivered in 3 days.</p>
          </div>
          <Link
            href="/plumbing/wash-basins"
